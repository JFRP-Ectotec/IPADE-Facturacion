...
FROM tbraccd
WHERE tbraccd_pidm = gb_common.f_get_pidm('A00085344')
	AND tbraccd_receipt_number = 2459
;

SELECT tbraccd_tran_number, tbraccd_detail_code, tbraccd_amount, tbraccd_receipt_number
FROM tbraccd
WHERE tbraccd_pidm = gb_common.f_get_pidm('A00085344')
	AND tbraccd_tran_number IN (16, 17)
;
...
DECLARE
	datos_banner CLOB;
	matricula VARCHAR2(20 CHAR) := 'A00085344';
	tran_number NUMBER := 42;
...
SELECT *
FROM gurdbug
WHERE  /*gurdbug_value LIKE '%mat%A00085344%'
    -- AND gurdbug_parm LIKE '%TZTRALX%'
    --AND*/  gurdbug_activity_date > TO_DATE('20-MAR-2026 20:38:00', 'DD-MON-YYYY HH24:MI:SS')
    AND gurdbug_activity_date < TO_DATE('20-MAR-2026 20:40:00', 'DD-MON-YYYY HH24:MI:SS') 
